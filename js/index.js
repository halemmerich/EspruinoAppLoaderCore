...
function getAppHTML(app, appInstalled, forInterface) {
  ...
  if (forInterface=="library") html += `
    ...
    <button class="btn btn-link btn-action btn-lg ${SETTINGS.alwaysAllowUpdate || version.canUpdate?"":"d-hide"}" appid="${app.id}" title="Update App"><i class="icon icon-refresh"></i></button>
